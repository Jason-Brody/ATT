...
namespace AIF.Scripts
{
    ...
    {
        private AIF.Data.Tasks _aifTask;
        ...
        public static void BD87(List<string> idocNumbers, string status) {
        ...
        public void BD87() {
            BD87(_iDocNumbers, "64");
            #region Origin BD87 Code
            //SAPTestHelper.Current.SAPGuiSession.StartTransaction("BD87");
            //SAPTestHelper.Current.MainWindow.FindByName<GuiButton>("%_SX_DOCNU_%_APP_%-VALU_PUSH").Press();
            //SAPTestHelper.Current.PopupWindow.FindDescendantByProperty<GuiTableControl>().SetBatchValues(_iDocNumbers);
            //SAPTestHelper.Current.PopupWindow.FindByName<GuiButton>("btn[8]").Press();
        ...
        public static void TrackStatus(List<string> iDocNumbers,string MsgType, string fileName) {
            ...
            SAPTestHelper.Current.MainWindow.FindByName<GuiCTextField>("S_MESTYP-LOW").Text = MsgType;
            ...
            SAPTestHelper.Current.MainWindow.FindByName<GuiTextField>("P_CPATH").Text = fileName;
        ...
        public void TrackStatus() {
            ...
            TrackStatus(_iDocNumbers, _aifTask.Interfaces.MsgType, _data.GetIDocITGFile());
